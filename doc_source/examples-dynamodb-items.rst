...
:aws-java-class-prev:`GetItemRequest <services/dynamodb/model/GetItemRequest>` object with the table
name and primary key value of the item you want. It returns a
:aws-java-class-prev:`GetItemResponse <services/dynamodb/model/GetItemResponse>` object with
...
(:aws-java-class-prev:`AttributeValue <services/dynamodb/model/AttributeValue>`) pairs that are associated
with the item.
...
.. note:: If the named table doesn't exist for your account and region, a
   :aws-java-class-prev:`ResourceNotFoundException <services/dynamodb/model/ResourceNotFoundException>` is
   thrown.
...
.. note:: If the named table doesn't exist for your account and region, or if the item identified by
   the primary key you passed in doesn't exist, a :aws-java-class-prev:`ResourceNotFoundException
